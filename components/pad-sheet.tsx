 ...
 */
export function PadSheet({ onClose, closeHint, children }: PadSheetProps) {
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={[styles.sheet, { width: Math.round(width * PAD_SHEET_RATIO), marginTop: insets.top + 8 }]}>
        {children}
