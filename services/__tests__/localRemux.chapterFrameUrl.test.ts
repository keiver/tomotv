...
describe("chapterFrameUrl", () => {
  it("names the frame by its start in whole milliseconds under the base", () => {
    expect(chapterFrameUrl("http://127.0.0.1:9/tok/", 100.5)).toBe("http://127.0.0.1:9/tok/frame-100500.jpg");
    expect(chapterFrameUrl("http://127.0.0.1:9/tok/", 0)).toBe("http://127.0.0.1:9/tok/frame-0.jpg");
    expect(chapterFrameUrl("http://127.0.0.1:9/tok/", 1.0004)).toBe("http://127.0.0.1:9/tok/frame-1000.jpg");
  });
  ...
  it("answers nothing without a base, and never a negative time", () => {
    ...
    expect(chapterFrameUrl("http://127.0.0.1:9/tok/", -3)).toBe("http://127.0.0.1:9/tok/frame-0.jpg");
  });
  ...
  it("builds on a session's master URL through sessionBaseUrl", () => {
    ...
    expect(chapterFrameUrl(base, 42)).toBe("http://127.0.0.1:9/tok/frame-42000.jpg");
  });
});
